...
import { Home, MessageCircle, User, PlusSquare, Bell, LogOut } from 'lucide-react';
...
export default function Layout() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
            {/* Desktop Sidebar */}
            <aside className="hidden md:flex w-72 flex-col bg-white/80 backdrop-blur-xl border-r border-white/50 min-h-screen fixed left-0 top-0 z-50 shadow-[0_0_40px_-10px_rgba(0,0,0,0.05)]">
                <div className="p-8">
            ...
            {/* Main Content */}
            <main className="flex-1 md:ml-72 pb-24 md:pb-10 px-4 py-6 max-w-5xl mx-auto w-full">
                <Outlet />
            </main>
            ...
            <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-xl border-t border-indigo-50/50 flex justify-around p-3 z-50 shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] pb-safe">
                ...
                <MobileNavItem to="/chat" icon={<MessageCircle size={24} />} count={3} />
