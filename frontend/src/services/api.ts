...
export const getFollowers = (id: number) => api.get(`/users/profile/${id}/followers`);
export const getFollowing = (id: number) => api.get(`/users/profile/${id}/following`);
export const getFriends = (id: number) => api.get(`/users/profile/${id}/friends`); // New
