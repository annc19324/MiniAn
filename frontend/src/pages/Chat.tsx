...
export default function Chat() {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-white dark:bg-slate-900 lg:z-auto lg:static lg:bg-transparent lg:inset-auto flex lg:h-[calc(100vh-80px)] lg:glass-card overflow-hidden">
